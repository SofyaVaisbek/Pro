...
class TomatoBush:
    ...
    def grow_all(self):
        for i in self.tomatoes:
            i.grow() #обновляем статус зрелости каждого помидора на +1
...
class Gardener:
    ...
    def knowladge_base():
        ...
        print("1) Помидоры имеют 4 стадии созревания: отсутсвует, цветение, зелёные, красные")
        print("2) Садовник может за ними ухаживать и собирать")
        print("3) Растение считается спелым, когда все помидоры на кусту стали красными")

tomatoBush = TomatoBush(5)
gardener = Gardener("Олег", tomatoBush)
